        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="index.php?action=updtWiki&id_w=<?= $wiki->getId_w() ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="titre">Titre:</label>
                            <input type="text" value="<?= $wiki->getTitre() ?>" class="form-control" id="titre"
                                name="titre" required>
                        </div>
                        <div class="form-group">
                            <label for="contenu">Contenu:</label>
                            <textarea class="form-control" id="contenu" name="contenu" rows="6"
                                placeholder="Write your wiki here..." required><?= $wiki->getContenu() ?></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="fk_cat" class="form-control">
                                <?php foreach ($catgs as $c): ?>
                                    <?php if ($c->getNom_cat() === $wiki->getFk_cat()) { ?>
                                        <option value="<?= $c->getNom_cat(); ?>" selected>
                                            <?= $c->getNom_cat() ?>
                                        </option>
                                    <?php } else { ?>
                        ...
                        <div class="form-group">
                            ...
                            <?php foreach ($tags as $tag) { ?>
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="<?= $tagValue; ?>">
                                        <?= $tagValue; ?>
                                    </label>
                                </div>
                            <?php } ?>
